...
def lgb_model():
    ...
    # 结果修正
    ans.loc[ans.inNums < 0, 'inNums'] = 0
    ans.loc[ans.outNums < 0, 'outNums'] = 0

    flag = (ans['startTime'] <= '2019-01-29 05:20:00') | (ans['startTime'] >= '2019-01-29 22:50:00')
    ans.loc[flag, 'inNums'] = 0

    flag = (ans['startTime'] <= '2019-01-29 05:40:00') | (ans['startTime'] >= '2019-01-29 23:00:00')
    ans.loc[flag, 'outNums'] = 0
